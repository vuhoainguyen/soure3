    ...
    function(a) {
        ...
        var b = {
            ...
            applyInputErrorStyling: function(a, b) {
                a.addClass(b.errorElementClass).removeClass("success"), this.getParentContainer(a).addClass(b.inputParentClassOnError).removeClass(b.inputParentClassOnSuccess), "" !== b.borderColorOnError && a.css("border-color", b.borderColorOnError)
            },
            applyInputSuccessStyling: function(a, b) {
                a.addClass("success"), this.getParentContainer(a).addClass(b.inputParentClassOnSuccess)
            },
            removeInputStylingAndMessage: function(a, c) {
                a.removeClass("success").removeClass(c.errorElementClass).css("border-color", "");
        ...
        a.formUtils = a.extend(a.formUtils || {}, {
            ...
            defaultConfig: function() {
                return {
                    ...
                    errorMessageClass: "text-form-error",
