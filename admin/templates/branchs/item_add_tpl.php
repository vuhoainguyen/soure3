...
<div class="content-header row align-items-center m-0">
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="index.html?com=branchs&act=man<?=$url_type?>">Danh sách <?=$csetting['name']?></a></li>
        </ol>
    </nav>
...
<div class="body-content">
    ...
    <form action="index.html?com=branchs&act=save<?=$url_type?><?=($_GET['id']) ? '&id='.$_GET['id']:''?>" method="post" name="form-action" id="form-action"  enctype="multipart/form-data" autocomplete="off" accept-charset="utf-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group text-right mb-0">
                                    ...
                                    <a role="button" href="index.html?com=branchs&act=man<?=$url_type?>" class="btn btn-fill btn-danger">Thoát</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <p class="text-danger">Width: <?=$setting['branchs'][$_GET['type']]['thumb-w']?>px - Height: <?=$setting['branchs'][$_GET['type']]['thumb-h']?>px</p>
                                </div>
            ...
            <div class="col-lg-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <?php if($csetting['address']==true) { ?>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <?php foreach ($config['website']['lang'] as $k => $v) { ?>
                                    <div class="form-group lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                                        <label class="font-weight-600">Địa chỉ [<?=$v?>]</label>
                                        <input type="text" class="form-control" value="<?=$item['address_'.$k]?>" data-validation="required" data-validation-error-msg="Địa chỉ không được để trống" id="address_<?=$k?>" name="data[address_<?=$k?>]" placeholder="Địa chỉ">
                                    </div>
                                    <?php } ?>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <?php if($csetting['email']==true) { ?>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="font-weight-600">Email</label>
                                    <input type="text" class="form-control" value="<?=$item['email']?>" data-validation="required" data-validation-error-msg="Email không được để trống" id="email" name="data[email]" placeholder="Email">
                                </div>
                            </div>
                            <?php } ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?=$item['phone']?>" data-validation="required" data-validation-error-msg="Phone không được để trống" id="phone" name="data[phone]" placeholder="Phone">
                                </div>
                            </div>
                            <?php } ?>
                            <?php if($csetting['hotline']==true) { ?>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="font-weight-600">Hotline</label>
                                    <input type="text" class="form-control" value="<?=$item['hotline']?>" data-validation="required" data-validation-error-msg="Hotline không được để trống" id="hotline" name="data[hotline]" placeholder="Hotline">
                                </div>
                            </div>
                            <?php } ?>
                        </div>
                        <?php if($csetting['maps']==true) { ?>
                        <div class="row">
                            <div class="col-md-12">
                               <div class="form-group">
                                    <label class="font-weight-600">Nhúng bản đồ</label>
                                    <textarea rows="4" cols="80" class="form-control" name="data[maps_frame]"><?=$item['maps_frame']?></textarea>
                                </div>
                            </div>
                        </div>
                        <?php } ?>
