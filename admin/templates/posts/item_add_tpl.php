...
<div class="content-header row align-items-center m-0">
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="index.html?com=posts&act=man<?=$url_type?>">Danh sách <?=$csetting['name']?></a></li>
        </ol>
    </nav>
...
<div class="body-content">
    ...
    <form action="index.html?com=posts&act=save<?=$url_type?><?=($_GET['id']) ? '&id='.$_GET['id']:''?>" method="post" name="form-action" id="form-action"  enctype="multipart/form-data" autocomplete="off" accept-charset="utf-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group text-right mb-0">
                                    ...
                                    <a role="button" href="index.html?com=posts&act=man<?=$url_type?>" class="btn btn-fill btn-danger">Thoát</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-group" style="overflow: hidden">
                                        ...
                                        <select class="form-control basic-single" name="data[id_service]" id="id_service">
                                            <option value="0">Chọn danh mục dịch vụ</option>
                                            <?php for($i=0;$i<count($items_dv);$i++){ ?>
                                            <option value="<?=$items_dv[$i]['id']?>" <?=($item['id_service']==$items_dv[$i]['id']) ? 'selected':''?>><?=$items_dv[$i]['name_vi']?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <?php if($_GET['type']=='tinh-chat'){ ?>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="font-weight-600">Màu border</label>
                                    <input type="color" class="form-control" value="<?=$item['colors_border']?>" data-validation="required" data-validation-error-msg="Chọn màu" id="colors_border" name="data[colors_border]" placeholder="Chọn màu">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="font-weight-600">Màu background</label>
                                    <input type="color" class="form-control" value="<?=$item['colors_background']?>" data-validation="required" data-validation-error-msg="Chọn màu" id="colors_background" name="data[colors_background]" placeholder="Chọn màu">
                                </div>
                            </div>
                        </div>
                        <?php } ?>
                                                ...
                                                <div class="columns">
                                                    ...
                                                    <div class="column-act">
                                                        <div class="column-actions">
                                                            <a class="fileuploader-action fileuploader-action-remove deleteImgMulti" data-table="post_photos" data-path="<?=$path?>" data-id="<?=$items_photo[$i]['id']?>" title="Xóa"><i></i></a>
                                                        </div>
                                                        <div class="numb-fileuploader"><input class="form-control-small" placeholder="Số thứ tự" value="<?=$items_photo[$i]['numb']?>" onkeyup="changeField('numb','post_photos',<?=$items_photo[$i]['id']?>,this.value)" data-id="<?=$items_photo[$i]['id']?>" /></div>
                                                    </div>
                                                    <div class="column-alt">
                                                        <div class="numb-alt"><input class="form-control-small" placeholder="Tên hình" value="<?=$items_photo[$i]['alt_vi']?>" onkeyup="changeField('alt_vi','post_photos',<?=$items_photo[$i]['id']?>,this.value)" data-id="<?=$items_photo[$i]['id']?>"/></div>
                                                    </div>
                                                </div>
                                            </li>
                                            <?php } ?>
