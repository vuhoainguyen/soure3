<div class="content-header row align-items-center m-0">
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="index.html?com=place_wards&act=man<?=$url_link?>">Danh sách</a></li>
    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Danh sách phường xã</h1>
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a class="btn btn-danger w-100p ml-1 deleteChoose" href="index.html?com=place_wards&act=delete<?=$url_link?>" role="button">Xóa chọn</a>
                            <a class="btn btn-success w-100p ml-1" href="index.html?com=place_wards&act=add<?=$url_link?>" role="button">Thêm mới</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <select class="form-control basic-single" onchange="window.location.href='index.html?com=place_wards&act=man&id_city='+this.value">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <select class="form-control basic-single" onchange="window.location.href='index.html?com=place_wards&act=man&id_city=<?=$_GET['id_city']?>&id_dist='+this.value">
                        ...
                        <table class="table display table-striped table-hover table-border">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="index.html?com=place_wards&act=edit<?=$url_link?>&id=<?=$v['id']?>" class="btn btn-success-soft btn-sm mr-1"><i class="typcn typcn-eye-outline"></i></a>
                                        <a href="index.html?com=place_wards&act=delete<?=$url_link?>&id=<?=$v['id']?>" onClick="if(!confirm('Xác nhận xóa')) return false;" class="btn btn-danger-soft btn-sm"><i class="typcn typcn-trash"></i></a>
                                    </td>
                                </tr>
                                <?php } } ?>
                            </tbody>
