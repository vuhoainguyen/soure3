...
<div class="content-header row align-items-center m-0">
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="index.html?com=place_citys&act=man">Tỉnh thành</a></li>
...
<div class="body-content">
    ...
    <form action="index.html?com=place_citys&act=save<?=($_GET['id']) ? '&id='.$_GET['id']:''?>" method="post" name="form-action" id="form-action"  enctype="multipart/form-data" autocomplete="off" accept-charset="utf-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group text-right mb-0">
                                    ...
                                    <a role="button" href="index.html?com=place_citys&act=man" class="btn btn-fill btn-danger">Thoát</a>
                                </div>
                            </div>
                        </div>
