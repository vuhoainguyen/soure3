                        ...
                        <table class="table <?php if($config['paging-table']==true){ ?>v table-borderless no-styling basic<?php }else{ ?>display table-striped table-hover table-border<?php } ?>">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php } ?>
                                    <td>
                                        <a href="index.html?com=meta_seos&act=edit&id=<?=$v['id']?>" class="btn btn-success-soft btn-sm mr-1"><i class="typcn typcn-eye-outline"></i></a>
                                        <?php if($config['meta-seo-debug']==true){ ?><a href="index.html?com=meta_seos&act=delete&id=<?=$v['id']?>" onClick="if(!confirm('Xác nhận xóa')) return false;" class="btn btn-danger-soft btn-sm"><i class="typcn typcn-trash"></i></a><?php } ?>
                                    </td>
                                </tr>
                                <?php } } ?>
                            </tbody>
