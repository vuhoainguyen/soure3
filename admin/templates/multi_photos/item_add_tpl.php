                    ...
                    <div class="card-body">
                        ...
                        <div class="row hinhanh">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="delete-img">
                                        <img src="<?=$path.$item['icon']?>" width="<?=($csetting['thumb-iw']<200) ? 200:$csetting['thumb-iw']?>" style="max-width: 100% !important;">
                                        <span class="deleteImg" data-table="<?=$_GET['com']?>" data-path="<?=$path?>" data-field="icon,icon_thumb,id_parent" data-id="<?=$item['id']?>"><i class="typcn typcn-trash"></i></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <p class="text-danger">Width: <?=$csetting['thumb-iw']?>px - Height: <?=$csetting['thumb-ih']?>px</p>
                                </div>
                                <div class="form-group mb-0">
            ...
            <div class="col-lg-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <?php if($csetting['has-code']==true){ ?>
                         <div class="row">
                            <div class="col-md-12">
                                 <div class="form-group">
                                    <label class="font-weight-600">Has code</label>
                                    <input type="text" class="form-control" value="<?=$item['has_code']?>" id="has_code" name="data[has_code]" placeholder="Has code">
                                </div>
                            </div>
                        </div>
                        <?php } ?>
                                                ...
                                                <div class="columns">
                                                    ...
                                                    <div class="column-act">
                                                        <div class="column-actions">
                                                            <a class="fileuploader-action fileuploader-action-remove deleteImg" data-table="multi_photos" data-field="id_parent" data-path="<?=$path?>" data-id="<?=$items_photo[$i]['id']?>" title="Xóa"><i></i></a>
                                                        </div>
                                                        <div class="numb-fileuploader"><input class="form-control-small" placeholder="Số thứ tự" value="<?=$items_photo[$i]['numb']?>" onkeyup="changeField('numb','multi_photos',<?=$items_photo[$i]['id']?>,this.value)" data-id="<?=$items_photo[$i]['id']?>" /></div>
                                                    </div>
                                                    <div class="column-alt">
                                                        <div class="numb-alt"><input class="form-control-small" placeholder="Tên hình" value="<?=$items_photo[$i]['alt_vi']?>" onkeyup="changeField('alt_vi','multi_photos',<?=$items_photo[$i]['id']?>,this.value)" data-id="<?=$items_photo[$i]['id']?>"/></div>
                                                    </div>
                                                </div>
                                            </li>
                                            <?php } ?>
