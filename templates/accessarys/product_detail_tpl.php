        ...
        <form method="post" data-role="add-to-cart" enctype="multipart/form-data" onsubmit="return false" name="product-detail-<?=$row_detail['id']?>" id="product-detail-<?=$row_detail['id']?>">
            ...
            <div id="content" class="row23 d-flex flex-wrap justify-content-start">
                ...
                <div class="item23 right">
                    ...
                    <?php } ?>
                    <?php /*<div class="hotline-product margin-top-15">
                    ...
                    <div class="social-link margin-top-20">
                        <a href="">
            ...
            <div class="section margin-top-20">
                <?php /*<div class="product-tab e-tabs">
                ...
                */ ?>
                <div class="row margin-bottom-20 d-flex justify-content-start flex-wrap">
                    <div class="col--3 item">
                        <div class="box-pi bg1">
                            <span><img src="images/baohanh.png" alt="Bảo hành chính hãng"></span>
                            <h6>Bảo hành chính hãng</h6>
                        </div>
                    </div>
                    <div class="col--3 item">
                        <div class="box-pi bg2">
                            <span><img src="images/giaotannoi.png" alt="Giao hàng tận nơi"></span>
                            <h6>Giao hàng tận nơi</h6>
                        </div>
                    </div>
                    <div class="col--3 item">
                        <div class="box-pi bg3">
                            <span><img src="images/tuvan.png" alt="Tư vấn nhiệt tình"></span>
                            <h6>Tư vấn nhiệt tình</h6>
                        </div>
                    </div>
                </div>
                <h6 class="name-title-page">Giới thiệu chi tiết</h6>
                <div class="detail-set">
                    <?php 
                        if(!empty($array_slider)){
                            $noidung = str_replace(array_keys($array_slider), array_values($array_slider), $func->checkSSLContent($row_detail['content']));
                ...
                <h6 class="name-title-page">Thông số kỹ thuật</h6>
                <div class="detail-set">
                    <?php 
                        if(!empty($array_slider)){
                            $noidung = str_replace(array_keys($array_slider), array_values($array_slider), $func->checkSSLContent($row_detail['parameter']));
                            echo htmlspecialchars_decode($func->checkSSLContent($noidung));
                        }else{
                            echo htmlspecialchars_decode($func->checkSSLContent($row_detail['parameter']));
                        }
                    ?>
                </div>
                <?php if(count($posts)>0){ foreach ($posts as $k => $v) { ?>
                <div class="detail-set"><?=htmlspecialchars_decode($func->checkSSLContent($v['content']))?></div>
                <?php } } ?>
                <h6 class="name-title-page">Bình luận</h6>
                <div class="fb-comments" data-href="<?=$func->getCurrentPageURL()?>" data-width="100%" data-numposts="5"></div>
            </div>
        ...
        <div class="section margin-top-20">
            ...
            <div class="product-view">
                <div class="row margin-top-10 d-flex flex-wrap justify-content-start" id="search-body" data-href="<?=$_GET['com']?>">
                    <?php if(!$func->isAjax()){ ?>
                    <?php echo $func->getTemplateProduct($product_other,'col--4 item','none-border','margin-bottom-10','resize/260x220/1/',0, array('moi'), 1); ?>
                    <?php } ?>
                </div>
            </div>
        </div>
