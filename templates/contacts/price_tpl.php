    ...
    <div class="container">
        ...
        <div class="row margin-top-20 d-flex flex-wrap justify-content-start">
            ...
            <div class="item col-8">
                <h4 class="title">
                    Nhập thông tin để chúng tôi có thể báo giá sản phẩm cho bạn.
                </h4>
                        ...
                        <div class="row d-flex flex-wrap justify-content-start">
                            ...
                            <div class="item col-6">
                                <div class="r-input margin-bottom-10">
                                    ...
                                    <input type="hidden" name="data[type]" class="input-control" id="type" value="bao-gia">
                                </div>
                                <div class="r-input margin-top-10 margin-bottom-0 text-right">
                                    <input type="hidden" name="recaptcha_response" id="recaptchaResponse">
                                    <button type="submit" class="button-control">Gửi báo giá</button>
                                </div>
                            </div>
                        </div>
                    </form>
